...
var pieces = {
  ...
  5: {
    name: "Great White",
    img: "app/assets/images/greatwhite.png"
  },
  4: {
    name: "Hammerhead",
    img: "app/assets/images/hammerhead.png"
  },
  3: {
    name: "Barracuda",
  ...
  1: {
    name: "Jellyfish",
    img: "app/assets/images/jellyfish.png"
  }
};
...
exports.drawWater = exports.drawBoardInitial = exports.drawBorder = exports.drawPiece = exports.positionMover = undefined;

var _piece_objects = __webpack_require__(0);

var _piece_objects2 = _interopRequireDefault(_piece_objects);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var positionMover = exports.positionMover = function positionMover(xPos, yPos, ctx, level) {
  var xCell = Math.floor(xPos / 40) * 40;
  var yCell = Math.floor(yPos / 40) * 40;
  if (xCell >= 40 && xCell < 400 && yCell >= 40 && yCell < 400) {
    var returnValue = [xCell, yCell];
    level.preset.forEach(function (block) {
...
var drawPiece = exports.drawPiece = function drawPiece(src, ctx, xVal, yVal) {
  var img = new Image();
  img.src = src;
  img.onload = function () {
...
var drawBorder = exports.drawBorder = function drawBorder(ctx, level) {
  var top = new Image();
  ...
  var xGoal = level.goal.xVal;
  var yGoal = level.goal.yVal;
  var goal = new Image();
  goal.src = xGoal === 0 || xGoal === 400 ? "app/assets/images/vertical.png" : "app/assets/images/horizontal.png";
  top.onload = function () {
    [40, 80, 120, 160, 200, 240, 280, 320, 360].forEach(function (coord) {
...
var drawBoardInitial = exports.drawBoardInitial = function drawBoardInitial(ctx, level) {
  var ocean = new Image();
  ocean.src = "app/assets/images/ocean.png";
  ocean.onload = function () {
    [40, 80, 120, 160, 200, 240, 280, 320, 360].forEach(function (x) {
      [40, 80, 120, 160, 200, 240, 280, 320, 360].forEach(function (y) {
    ...
    level.preset.forEach(function (preset) {
      var piece = _piece_objects2.default[preset.pieceValue];
      drawPiece(piece.img, ctx, preset.xVal, preset.yVal);
    });
  };
};

var drawWater = exports.drawWater = function drawWater(ctx, xVal, yVal) {
  var img = new Image();
...
var _assorted_functions = __webpack_require__(2);
...
document.addEventListener("DOMContentLoaded", function () {
  var origLevels = [_level2.default, _level4.default, _level6.default];
  var levels = [];
  origLevels.forEach(function (level) {
    levels.push((0, _lodash.merge)({}, level));
  });
  var levelIndex = 0;

  var levelSetup = function levelSetup(level) {
    $("#level-header").html('Level ' + level.levelNum); //Add Level Header to Level Div
    var selectedPieceKey = null; //Establish dummy Selected Piece
    $("#game-board").replaceWith($('#game-board').clone());
    $("#game-pieces").replaceWith($('#game-pieces').clone());
    var board = $("#game-board")[0];
    var ctx = board.getContext('2d'); //Establish board ctx
    var userPiecesCanvas = $("#game-pieces")[0];
    var userPiecesCtx = userPiecesCanvas.getContext('2d');
    var levelGoalCanvas = $("#level-goal-piece")[0];
    var levelGoalCtx = levelGoalCanvas.getContext('2d');
    levelGoalCtx.clearRect(0, 0, 44, 44);
    (0, _assorted_functions.drawPiece)(level.catch.img, levelGoalCtx, 2, 2);
    (0, _assorted_functions.drawBoardInitial)(ctx, level);
    // $("#level-goal-piece").empty().append(`<img class="level-goal-piece" src=${level.catch.img}>`);
    var gameInterval = void 0; //Establish dummy gameInterval

    // Add User Pieces to User Area
    userPiecesCtx.clearRect(0, 0, 44, 420);
    var xPos = 0;
    Object.keys(level.user).forEach(function (pieceKey) {
      var piece = level.user[pieceKey];
      (0, _assorted_functions.drawPiece)(piece.img, userPiecesCtx, xPos, 0);
      xPos += 45;
    });

    // Add Drag Handler to User Pieces
    userPiecesCanvas.addEventListener("mousedown", function (drag) {
      var pos = userPiecesCanvas.getBoundingClientRect();
    ...
    board.addEventListener("mouseup", function (drag) {
      var pos = board.getBoundingClientRect();
      var cell = (0, _assorted_functions.positionMover)(drag.x - pos.left, drag.y - pos.top, ctx, level);
      if (cell) {
        var pieceObject = level.user[selectedPieceKey];
        var pieceValue = pieceObject.pieceValue;
        if (pieceObject.xVal) (0, _assorted_functions.drawWater)(ctx, pieceObject.xVal, pieceObject.yVal);
        (0, _assorted_functions.drawPiece)(_piece_objects2.default[pieceValue].img, ctx, cell[0], cell[1]);
    ...
    $("#start-button").on("click", function () {
      ...
      var goal = [level.goal.xVal, level.goal.yVal, level.catch.value];
      var positions = [];
      level.preset.forEach(function (piece) {
        positions.push({ xVal: piece.xVal, yVal: piece.yVal, xValPrev: null, yValPrev: null,
          img: _piece_objects2.default[piece.pieceValue].img,
          value: piece.pieceValue, vel: null });
      });
      (0, _lodash.values)(level.user).forEach(function (piece) {
        if (piece.xVal) {
          positions.push({ xVal: piece.xVal, yVal: piece.yVal, xValPrev: null, yValPrev: null,
            img: _piece_objects2.default[piece.pieceValue].img,
            value: piece.pieceValue, vel: null });
      ...
      gameInterval = setInterval(function () {
        var victory = (0, _game2.default)(ctx, positions, goal);
        if (victory) {
...
var runGame = function runGame(ctx, positions, goal) {
  var victory = false;
    ...
    if (pos.xValPrev) {
      if (pos.xValPrev === goal[0] && pos.yValPrev === goal[1]) {
        if (pos.xValPrev === 0 || pos.xValPrev === 400) {
          (0, _assorted_functions.drawPiece)("app/assets/images/vertical.png", ctx, pos.xValPrev, pos.yValPrev);
        } else {
          (0, _assorted_functions.drawPiece)("app/assets/images/horizontal.png", ctx, pos.xValPrev, pos.yValPrev);
        }
      } else {
        (0, _assorted_functions.drawWater)(ctx, pos.xValPrev, pos.yValPrev);
      }
    }
    (0, _assorted_functions.drawPiece)(pos.img, ctx, pos.xVal, pos.yVal);
  });

  // Set New Velocities If Next To Scary Positions
  positions.forEach(function (pos1) {
    positions.forEach(function (pos2) {
...
var level1 = {
  preset: [{ xVal: 80, yVal: 80, pieceValue: 5 }, { xVal: 120, yVal: 200, pieceValue: 4 }],
  user: {
    1: { xVal: null, yVal: null, pieceValue: 6, img: "app/assets/images/bluewhale.png", name: "bluewhale" }
  },
  goal: { xVal: 400, yVal: 200 },
  levelNum: 1,
  catch: { value: 4, img: "app/assets/images/hammerhead.png" }
};
...
var level2 = {
  ...
  user: {
    1: { xVal: null, yVal: null, pieceValue: 6, img: "app/assets/images/bluewhale.png", name: "bluewhale" },
    2: { xVal: null, yVal: null, pieceValue: 3, img: "app/assets/images/barracuda.png", name: "barracuda" }
  },
...
var level3 = {
  preset: [{ xVal: 160, yVal: 200, pieceValue: 3 }, { xVal: 240, yVal: 160, pieceValue: 4 }, { xVal: 320, yVal: 240, pieceValue: 2 }, { xVal: 120, yVal: 80, pieceValue: 4 }, { xVal: 80, yVal: 40, pieceValue: 5 }],
  user: {
